...
This will turn an image into a classic black and white photo. Then the next thing to do is invert the grayscale image also called negative image,
...
Link: https://thecleverprogrammer.com/2020/09/30/pencil-sketch-with-python/"""
